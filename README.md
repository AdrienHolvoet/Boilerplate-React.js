...
This is a simple Boilerplate for React.js with a simple architecture, sass, breakpoint sass, prettier, ESLINT,  prettier ESLINT, login/register page with jwt token, React Hook Form, React Router, Redux .
